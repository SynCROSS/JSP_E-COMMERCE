...
<table border="1">
	...
	<%
		...
		String query = "SELECT " + 
		"PAYMENT_HISTORY.ID, PAYMENT_HISTORY.ORDER_DATE, " + 
		"PAYMENT_HISTORY.ORDER_STATUS, PAYMENT_HISTORY.ORDER_PRICE, "+
		"PAYMENT_HISTORY.ORDER_COUNT, PRODUCT.NAME AS PRODUCT_NAME, MEMBER.NAME AS MEMBER_NAME " + 
		"FROM "
